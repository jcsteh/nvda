...
from ctypes import *
from ctypes.wintypes import HWND, BOOL, ULONG
from comtypes import HRESULT, GUID, COMMETHOD, IUnknown, tagBIND_OPTS2, COMError
...
class IMultiQI(IUnknown):
	...
	def QueryMultipleInterfaces(self, interfaces):
		...
		for interface, mqi in zip(interfaces, mqis):
